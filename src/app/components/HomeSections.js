  ...
  return (
    <div className={s.halfRow} ref={ref}>
      ...
      <div className={s.copy}>
        ...
        <p className={s.subhead}>You fill your canvas by adding the needs you want to focus on. MyMaslow gives you a library of needs to choose from, test, and customize to create a lifestyle that gives you energy.</p>
      </div>
    </div>
  )
}
